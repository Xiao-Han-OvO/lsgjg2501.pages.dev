...
const rawGroups = [
  ...
  },
  {
    ...
    members: ["曾浚源", "何牧原", "李嘉峻", "龚鸿仁杰", "邓子轩", "范亦宸", "杨可为", "陈佳怡", "晏子晖", "刘昊梁", "邓一滔", "黎劢", "李皓", "张澍泽", "魏子翔", "李世航", "李昕玥"]
  },
  {
    name: "物理竞赛组",
    color: "from-purple-400 to-indigo-500",
    members: ["范文熙", "高铭森", "夏思妍", "艾可为", "喻涵博", "黄季熙", "张天骏", "杨谨逸", "胡清清", "董晋玮", "肖浩寅", "李诺辰", "周彦宏", "杨钰航", "毛敏劼", "刘子曦", "李书坦", "王睿捷", "李晟"]
  },
  {
    name: "化学竞赛组",
